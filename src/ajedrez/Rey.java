...
public class Rey extends javax.swing.JFrame {
    ...
    public char obtenerPieza(){
        ...
        boolean valid = false;
        while(valid == false){
            pieza = JOptionPane.showInputDialog("Ingrese un caracter para simbolizar su rey:");
            if (pieza == null) {
                this.valid = false;
                valid = true;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rey.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
